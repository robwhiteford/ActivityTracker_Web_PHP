        ...
        <form id="form" name="form"  method="POST">
            ...
            <?php
                ...
                if ($rowcount > 0)
                {
                    ...
                    echo "<div id=\"curve_chart\" style=\"width: 1000px; margin:5px; text-align: center; height:550px;\"></div>";
                    echo " <script type=\"text/javascript\" src=\"https://www.gstatic.com/charts/loader.js\"></script>
                        ...
                        function drawChart() {
                            ...
                            ['Date', 'Average Pace', 'Maximum Pace'],
                                $entry
                            ]);
                ...
                <table id="activityTable" class="display" style="width:100%">
                    ...
                    <?php
                        try 
                        {
                            ...
                            {
                                $tempString = '';
                                echo "<tr><td>".$row["Date"]."</td><td>".$row["AveragePace"]."</td><td>".$row["MaxPace"]."</td></tr>";
                            }
                        } catch (Exception $e) {
                            echo 'Caught exception: ',  $e->getMessage(), "\n";
                        }
